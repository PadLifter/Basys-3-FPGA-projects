...
namespace eval ::optrace {
  variable script "C:/git/Basys-3-FPGA-projects/LED exercise/LED exercise.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {C:/git/Basys-3-FPGA-projects/LED exercise/LED exercise.cache/wt} [current_project]
  set_property parent.project_path {C:/git/Basys-3-FPGA-projects/LED exercise/LED exercise.xpr} [current_project]
  set_property ip_output_repo {{C:/git/Basys-3-FPGA-projects/LED exercise/LED exercise.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{C:/git/Basys-3-FPGA-projects/LED exercise/LED exercise.runs/synth_1/top.dcp}}
